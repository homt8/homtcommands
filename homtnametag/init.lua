minetest.register_privilege("homtnametag_admin", "homtnametag_admin. set a new admin system to give the commando on color value and also privs can da with list color value name")
minetest.register_privilege("homtnametag", "homtnametag. set a new system to give the color name about a problem that nametag the command of usertv before it clears privs is same day")
...
minetest.register_chatcommand("nametag",{
	...
	privs = {shout=true, homtnametag=true},
